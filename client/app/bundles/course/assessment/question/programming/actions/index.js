...
export function fetchQuestion() {
  return (dispatch) => {
    dispatch({ type: actionTypes.FETCH_QUESTION_REQUEST });

    return CourseAPI.assessment.question.programming.edit()
      ...
      .catch(() => dispatch({ type: actionTypes.FETCH_QUESTION_FAILURE }));
  };
}
